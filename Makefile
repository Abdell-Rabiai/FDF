...
SOURCES = $(shell ls libft_utils/*.c) $(shell ls mandatory/*.c) $(shell ls get_next_line/*.c) $(shell ls bonus/*.c) 

HEADER_FILES = get_next_line/get_next_line.h mandatory/fdf.h bonus/fdf_bonus.h
